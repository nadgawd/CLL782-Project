...
Based on the updated layout plan and campus map, the festival's primary ``Region of Interest'' (ROI) spans a specific central band covering approximately \textbf{85 acres} (34.4 hectares), representing about 27\% of the total 320-acre IIT Delhi campus. This region encompasses the high-activity zones in the West (Nalanda/SAC), Center (Sports Complex), and East (Academic Core, Rose Garden, LHC), excluding the Northern hostels and Main Gate approach.

For the purpose of spatial modeling in Module 3.2, this ROI is divided into a fine grid of \textbf{142 cells}, each approximately \textbf{0.6 acres} ($50\text{m} \times 50\text{m}$) in size. The detailed breakdown of sub-zones is provided in Table \ref{tab:roi_refined}.
...
East & Academic Core, LHC, Rose Garden & 30 & Academic/Green \\
Circulation & Connecting Pathways & 5 & Roads \\
\midrule
  & \textbf{Total ROI} & \textbf{85} & --- \\
\bottomrule
\end{tabular}
\end{table}
